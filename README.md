This project implements a simple Library Management System using object-oriented programming in C++. The system allows you to manage books, members, and transactions (such as borrowing books) in a library.
